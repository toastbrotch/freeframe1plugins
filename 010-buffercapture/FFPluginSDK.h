...
#ifndef FFPLUGINSDK_STANDARD
#define FFPLUGINSDK_STANDARD
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// \class		CFreeFramePlugin
///	\brief		CFreeFramePlugin is the base class for all FreeFrame plugins developed with the FreeFrame SDK. 
/// \author		Gualtiero Volpe
/// \date		20041110
/// \version	1.0.0.2
///
/// The CFreeFramePlugin class is the base class for every FreeFrame plugins developed with the FreeFrame SDK. 
/// It is derived from CFFPluginManager, so that most of the plugin management and communication with the host 
/// can be transparently handled through the default implementations of the methods of CFFPluginManager. 
/// While CFFPluginManager is used by the global FreeFrame methods, CFreeFramePlugin provides a default implementation 
/// of the instance specific FreeFrame functions. Note that CFreeFramePlugin methods are virtual methods: any given 
/// FreeFrame plugin developed with the FreeFrame SDK will be a derived class of CFreeFramePlugin and will have to 
/// provide a custom implementation of most of such methods. Except for CFreeFramePlugin::GetParameterDisplay and 
/// CFreeFramePlugin::GetInputStatus, all the default methods of CFreeFramePlugin just return FF_FAIL: every derived 
...
public:
	...
	/// The only public data field CFreeFramePlugin contains is m_pPlugin, a pointer to the plugin instance. 
...
protected:
	...
	/// The only protected function of CFreeFramePlugin is its constructor. In fact, nor CFFPluginManager objects nor 
	/// CFreeFramePlugin objects should be created directly, but only objects of the subclasses implementing specific 
