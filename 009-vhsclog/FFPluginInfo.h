...
#ifndef FFPLUGININFO_STANDARD
#define FFPLUGININFO_STANDARD
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// \class		CFFPluginInfo
///	\brief		CFFPluginInfo manages static information concerning a plugin name, version, and description. 
/// \author		Gualtiero Volpe
/// \date		20041110
/// \version	1.0.0.2
///
/// The CFFPluginInfo class manages static information related to a FreeFrame plugin. Examples are the name of 
...
/// The CFFPluginInfo class is also involved in the process of creating an instance of the subclass implementing 
...
public:
	...
	/// The constructor of CFFPluginInfo receives through its parameters the information that needs
	/// to be stored.
	/// 
